...
python .\eval_retrieval.py --model "openai/clip-vit-base-patch32" --tokenizer "sentence-transformers/clip-ViT-B-32-multilingual-v1" --text-encoder .\models\sbert\clip_b32\distilbert\model\model.onnx --image-encoder .\models\sbert\clip_b32\image\model.onnx --dataset "nlphuji/flickr_1k_test_image_text_retrieval"
